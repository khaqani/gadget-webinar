...
class WebinarController extends Controller
{
    ...
    switch ($sort) {
        ...
        if ($request->ajax()) {
            return view('Webinar.Account.webinars.load', ['items' => $items])->render();  
        }
        ...
        $cities = City::whereNotNull('id')->get();
            ...
            return view('Webinar.Account.webinars.list', [
            'items' => $items,
            'provinces' => $provinces,
            'cities' => $cities,
        ]);
    ...
    public function show($slug){
        ...
        return view('Webinar.Account.webinars.show', [
            'item' => $item,
            'buyuser' => $buyuser,
        ]);
    ...
    {
        return view('Webinar.Account.webinars.request');
    }
    ...
    switch ($sort) {
        ...
        switch ($status) {
            ...
            return view('Account.webinars.accounts.movie.mylist', [
