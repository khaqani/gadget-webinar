...
class CategoryController extends Controller
{
    ...
    {
        $items = Category::whereNotNull('id');
    ...
    switch ($sort) {
        ...
        if ($request->ajax()) {
            return view('Webinar.Front.categories.load', ['items' => $items])->render();  
        }
        ...
        $cities = City::whereNotNull('id')->get();
            ...
            return view('Webinar.Front.categories.index', [
            'items' => $items,
            'provinces' => $provinces,
            'cities' => $cities,
        ]);
    ...
    public function show(Request $request, $slug){
        ...
        return view('Webinar.Front.categories.show', [
            'item' => $category,
            'items' => $items,
        ]);
