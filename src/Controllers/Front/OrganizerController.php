...
class OrganizerController extends Controller
{
    ...
    switch ($sort) {
        ...
        if ($request->ajax()) {
            return view('Webinar.Front.organizers.load', ['items' => $items])->render();  
        }
        ...
        $cities = City::whereNotNull('id')->get();
            ...
            return view('Webinar.Front.organizers.index', [
            'items' => $items,
            'provinces' => $provinces,
            'cities' => $cities,
        ]);
    ...
    public function show(Request $request, $slug){
        $item = Organizer::where('slug', $slug)->first();
        ...
        return view('Webinar.Front.organizers.show', [
            'item' => $item,
            'items' => $items,
        ]);
